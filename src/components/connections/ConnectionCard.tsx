...
export const ConnectionCard: React.FC<ConnectionCardProps> = ({
  ...
  return (
    <div className="group bg-card border border-border rounded-lg p-4 transition-all duration-150 hover:shadow-xs hover:border-primary/40 flex flex-col justify-between">
      {/* Top Header */}
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div
            className={`p-2 rounded-md border flex items-center justify-center shrink-0 ${
              isSSH
      ...
      <div className="pt-3 mt-3 border-t border-border flex items-center justify-between">
        <span className="text-[11px] font-mono font-medium text-muted-foreground bg-secondary px-2 py-0.5 rounded border border-border">
          {connection.protocol}
        </span>

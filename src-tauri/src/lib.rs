...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ssh_cmd::get_server_health,
            ...
            commands::sftp_cmd::get_local_roots,
            commands::sftp_cmd::list_local_dir,
            commands::sftp_cmd::create_local_dir,
            commands::sftp_cmd::delete_local_item,
            commands::sftp_cmd::read_sftp_file_content,
            commands::sftp_cmd::write_sftp_file_content,
            commands::sftp_cmd::read_local_file_content,
            commands::sftp_cmd::write_local_file_content,
            commands::snippet_cmd::create_snippet,
            commands::snippet_cmd::get_all_snippets,
            commands::snippet_cmd::update_snippet,
